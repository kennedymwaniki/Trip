    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('museum', 'Museum'), ('restaurant', 'Restaurant'), ('park', 'Park'), ('dining', 'Dining'), ('General', 'general'), ('shopping', 'Shopping'), ('event', 'Event')], default='General', max_length=100)),
